...
class ResponseControllerUtilsTests: XCTestCase {
    ...
    func testNoResponseNoError() {
        do {
            try ResponseControllerUtils.checkStatusCodeAndData((data:nil, urlResponse:nil), mitigator: errorController)
        }  catch {
    ...
    func testAuthenticationError() {
        ...
        do {
            try ResponseControllerUtils.checkStatusCodeAndData((data:nil, urlResponse:response), mitigator: errorController)
    ...
    func testValidResponse200WithData() {
        ...
        let response = NSHTTPURLResponse(URL:url!, statusCode: 200, HTTPVersion: nil, headerFields: nil)
        do {
            try ResponseControllerUtils.checkStatusCodeAndData((data:data, urlResponse:response), mitigator: errorController)
            XCTAssertTrue(true)
        } catch {
