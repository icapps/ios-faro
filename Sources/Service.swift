...
open class Service {
    ...
    open func perform<M: Mappable>(_ call: Call, result: @escaping (Result<M>) -> ()) {
    ...
    open func checkStatusCodeAndData<M: Mappable>(_ data: Data?, urlResponse: URLResponse?, error: Error?, result: (Result<M>) -> ()) {
