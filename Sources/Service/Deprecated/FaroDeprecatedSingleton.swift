...
open class FaroDeprecatedSingleton {
    ...
    public static func setup(with baseURL: String, session: FaroSessionable = FaroSession()) {
        FaroDeprecatedSingleton.sharedDeprecatedService = DeprecatedService(configuration: Configuration(baseURL: baseURL), faroSession: session)
    }
    ...
    public static var shared: DeprecatedService {
        guard let sharedDeprecatedService = FaroDeprecatedSingleton.sharedDeprecatedService else {
            ...
            return FaroDeprecatedSingleton.sharedDeprecatedService!
        }
